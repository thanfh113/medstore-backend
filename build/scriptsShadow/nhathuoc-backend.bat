...
set CLASSPATH=%APP_HOME%\lib\nhathuoc-backend-all.jar

@rem Execute nhathuoc-backend
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NHATHUOC_BACKEND_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%NHATHUOC_BACKEND_EXIT_CONSOLE%" exit 1
exit /b 1
